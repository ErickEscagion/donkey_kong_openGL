...
namespace Game.Level1.Scripts
{
    ...
    internal class Scenario : MonoBehaviour
    {
        ...
        private void Floor(float p1, float p2, float pass, int lines, int coluns)
        {
            mat.SetPass(0);
            GL.Begin(GL.QUADS);
            //start
        ...
        [SerializeField]private float p1 = 19.0f, p2 = 33.5f, pass = 4f;
    [SerializeField]private int lines = 4, coluns = 11;
    }
}
