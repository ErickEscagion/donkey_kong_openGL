...
#pragma warning restore 649
        ...
        private void DrawWalls()
        {
            ...
            GL.Vertex3(p2 + pass * columns + size, p1 + (pass * lines / 2) - pass, 0);
            GL.Vertex3(p2 + pass * columns, p1 + (pass * lines / 2) - pass, 0);
            //6
            GL.Vertex3(p2 + pass * columns, p1 + pass * lines / 2 - pass - size, 0);
            GL.Vertex3(p2 + pass * columns, p1 + pass * lines / 2 - pass, 0);
            GL.Vertex3(p2 + pass * columns + pass * 3, p1 + pass * lines / 2 - pass, 0);
            GL.Vertex3(p2 + pass * columns + pass * 3, p1 + pass * lines / 2 - pass - size, 0);
            //7
            GL.Vertex3(p2 + pass * columns + pass * 3, p1 + pass * lines / 2 - pass - size, 0);
            GL.Vertex3(p2 + pass * columns + pass * 3 + size, p1 + pass * lines / 2 - pass - size, 0);
            GL.Vertex3(p2 + pass * columns + pass * 3 + size, p1 + pass * lines / 2 + pass + size, 0);
            GL.Vertex3(p2 + pass * columns + pass * 3, p1 + pass * lines / 2 + pass + size, 0);
            //8
            GL.Vertex3(p2 + pass * columns, p1 + (pass * lines / 2) + pass, 0);
            ...
            GL.Vertex3(p2 + pass * columns, p1 + (pass * lines / 2) + pass, 0);
            GL.Vertex3(p2 + pass * columns + size, p1 + (pass * lines / 2) + pass, 0);
            GL.Vertex3(p2 + pass * columns + size, p1 + (pass * lines) + size, 0);
